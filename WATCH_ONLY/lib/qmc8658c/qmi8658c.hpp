...
#define QMI8658C_RESET 0x60  // Host Commands
...
class QMI8658C {
    ...
    {
        QMI8658WomThreshold_high = 255, /*!< High threshold - large motion needed to wake. */
        QMI8658WomThreshold_medium = 128, /*!< Medium threshold - some motion needed to wake. */
    ...
    void QMI8658_enableWakeOnMotion();
    void QMI8658_disableWakeOnMotion();
};
